...
export const enum_users_permissions = pgEnum('enum_users_permissions', [
  'payroll_access',
  'payroll_admin',
])
...
export const enum_users_status = pgEnum('enum_users_status', ['active', 'inactive', 'suspended'])
export const enum_users_investment_details_profit_distribution_type = pgEnum(
  'enum_users_investment_details_profit_distribution_type',
  ['fixed', 'variable'],
)
export const enum_users_membership_tier = pgEnum('enum_users_membership_tier', [
  'bronze',
  'silver',
  'gold',
  'platinum',
])
export const enum_users_last_repayment_status = pgEnum('enum_users_last_repayment_status', [
  'ontime',
  'late',
  'default',
])
export const enum_users_auth_provider = pgEnum('enum_users_auth_provider', [
  'local',
  'google',
  'facebook',
])
export const enum_employers_auth_provider = pgEnum('enum_employers_auth_provider', [
  'local',
  'google',
  'facebook',
])
export const enum_employers_business_type = pgEnum('enum_employers_business_type', [
  'corporation',
  'partnership',
  'soleProprietorship',
])
export const enum_employers_status = pgEnum('enum_employers_status', [
  'active',
  'inactive',
  'suspended',
])
export const enum_employers_payroll_settings_payroll_cycle = pgEnum(
  'enum_employers_payroll_settings_payroll_cycle',
  ['monthly', 'semi_monthly', 'weekly', 'bi_weekly'],
)
export const enum_employers_risk_assessment_risk_category = pgEnum(
  'enum_employers_risk_assessment_risk_category',
  ['lowRisk', 'mediumRisk', 'highRisk'],
)
export const enum_employers_risk_profile_risk_rating = pgEnum(
  'enum_employers_risk_profile_risk_rating',
  ['AAA', 'AA', 'A', 'BBB', 'BB', 'B', 'CCC', 'CC', 'C', 'D'],
)
export const enum_employees_advance_history_status = pgEnum(
  'enum_employees_advance_history_status',
  ['pending', 'approved', 'rejected', 'disbursed', 'completed'],
)
export const enum_employees_documents_document_type = pgEnum(
  'enum_employees_documents_document_type',
  ['id', 'contract', 'other'],
)
export const enum_employees_marital_status = pgEnum('enum_employees_marital_status', [
  'single',
  'married',
  'widowed',
  'divorced',
])
export const enum_employees_employment_type = pgEnum('enum_employees_employment_type', [
  'full_time',
  'part_time',
  'contract',
])
export const enum_employees_employment_status = pgEnum('enum_employees_employment_status', [
  'regular',
  'probationary',
  'contract',
  'part_time',
])
export const enum_employees_advance_settings_risk_category = pgEnum(
  'enum_employees_advance_settings_risk_category',
  ['lowRisk', 'mediumRisk', 'highRisk'],
)
export const enum_employees_bank_details_account_type = pgEnum(
  'enum_employees_bank_details_account_type',
  ['savings', 'checking', 'payroll'],
)
export const enum_employees_auth_provider = pgEnum('enum_employees_auth_provider', [
  'local',
  'google',
  'facebook',
])
export const enum_employees_status = pgEnum('enum_employees_status', [
  'pending',
  'active',
  'suspended',
])
export const enum_employees_membership_tier = pgEnum('enum_employees_membership_tier', [
  'bronze',
  'silver',
  'gold',
  'platinum',
])
export const enum_payroll_advances_status = pgEnum('enum_payroll_advances_status', [
  'requested',
  'approved',
  'disbursed',
  'repaid',
...
export const enum_payroll_advances_membership_tier = pgEnum(
  'enum_payroll_advances_membership_tier',
  ['bronze', 'silver', 'gold', 'platinum'],
)
export const enum_payroll_transactions_fees_fee_type = pgEnum(
  'enum_payroll_transactions_fees_fee_type',
  ['processing', 'wire', 'late', 'other'],
)
export const enum_payroll_transactions_transaction_type = pgEnum(
  'enum_payroll_transactions_transaction_type',
  ['disbursement', 'repayment', 'fee'],
)
export const enum_payroll_transactions_payment_status = pgEnum(
  'enum_payroll_transactions_payment_status',
  ['processing', 'completed', 'failed', 'pending', 'cancelled'],
)
export const enum_payroll_transactions_reconciliation_status = pgEnum(
  'enum_payroll_transactions_reconciliation_status',
  ['pending', 'matched', 'unmatched', 'reconciled'],
)
export const enum_factoring_calculations_risk_category = pgEnum(
  'enum_factoring_calculations_risk_category',
  ['lowRisk', 'mediumRisk', 'highRisk'],
)
export const enum_factoring_repayments_late_fees_fee_type = pgEnum(
  'enum_factoring_repayments_late_fees_fee_type',
  ['fixed', 'percentage'],
)
export const enum_factoring_repayments_payment_history_payment_method = pgEnum(
  'enum_factoring_repayments_payment_history_payment_method',
  ['bank', 'debit', 'check'],
)
export const enum_factoring_repayments_payment_status = pgEnum(
  'enum_factoring_repayments_payment_status',
  ['pending', 'paid', 'overdue', 'defaulted', 'partially_paid'],
)
...
export const media = pgTable(
  'media',
  {
    ...
    companyUUID: varchar('company_u_u_i_d').notNull(),
...
export const users_permissions = pgTable(
  'users_permissions',
  {
    ...
    parent: integer('parent_id').notNull(),
    value: enum_users_permissions('value'),
    id: serial('id').primaryKey(),
  },
  (columns) => ({
    orderIdx: index('users_permissions_order_idx').on(columns.order),
    parentIdx: index('users_permissions_parent_idx').on(columns.parent),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [users.id],
      name: 'users_permissions_parent_fk',
    }).onDelete('cascade'),
  }),
)
...
export const users = pgTable(
  'users',
  {
    ...
    companyUUID: varchar('company_u_u_i_d'),
    ...
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    employeeProfile: integer('employee_profile_id').references(() => employees.id, {
      onDelete: 'set null',
    }),
    employerProfile: integer('employer_profile_id').references(() => employers.id, {
      onDelete: 'set null',
    }),
    investmentDetails_totalInvestment: numeric('investment_details_total_investment').default('0'),
    investmentDetails_expectedReturnRate: numeric('investment_details_expected_return_rate'),
    investmentDetails_profitDistributionType:
      enum_users_investment_details_profit_distribution_type(
        'investment_details_profit_distribution_type',
      ),
    membershipTier: enum_users_membership_tier('membership_tier').default('bronze'),
    advanceLimit: numeric('advance_limit').default('30'),
    previousDefaults: numeric('previous_defaults').default('0'),
    lastRepaymentStatus: enum_users_last_repayment_status('last_repayment_status'),
    authProvider: enum_users_auth_provider('auth_provider').notNull().default('local'),
  ...
  (columns) => ({
    users_user_id_idx: uniqueIndex('users_user_id_idx').on(columns.userId),
    users_employee_profile_idx: index('users_employee_profile_idx').on(columns.employeeProfile),
    users_employer_profile_idx: index('users_employer_profile_idx').on(columns.employerProfile),
    users_email_idx: uniqueIndex('users_email_idx').on(columns.email),
  }),
)

export const employers_payroll_settings_payroll_dates = pgTable(
  'employers_payroll_settings_payroll_dates',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('employers_payroll_settings_payroll_dates_order_idx').on(columns._order),
    _parentIDIdx: index('employers_payroll_settings_payroll_dates_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [employers.id],
      name: 'employers_payroll_settings_payroll_dates_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const employers = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    authProvider: enum_employers_auth_provider('auth_provider').notNull().default('local'),
    ...
    address_barangay: varchar('address_barangay').notNull(),
    address_cityDistrict: varchar('address_city_district').notNull(),
    address_province: varchar('address_province').notNull(),
    address_zipCode: varchar('address_zip_code').notNull(),
    businessType: enum_employers_business_type('business_type').notNull(),
    industry: varchar('industry').notNull(),
    payrollProvider: varchar('payroll_provider'),
    status: enum_employers_status('status').default('active'),
    lastLogin: timestamp('last_login', { mode: 'string', withTimezone: true, precision: 3 }),
    payrollSettings_payrollCycle: enum_employers_payroll_settings_payroll_cycle(
      'payroll_settings_payroll_cycle',
    ).notNull(),
    factoringAgreementSigned: boolean('factoring_agreement_signed').default(false),
    creditLimit: numeric('credit_limit').notNull(),
    bankDetails_bankName: varchar('bank_details_bank_name').notNull(),
    bankDetails_accountNumber: varchar('bank_details_account_number').notNull(),
    bankDetails_accountName: varchar('bank_details_account_name').notNull(),
    riskAssessment_creditScore: numeric('risk_assessment_credit_score'),
    riskAssessment_riskCategory: enum_employers_risk_assessment_risk_category(
      'risk_assessment_risk_category',
    ),
    riskProfile_creditLimit: numeric('risk_profile_credit_limit').notNull().default('0'),
    riskProfile_riskRating: enum_employers_risk_profile_risk_rating('risk_profile_risk_rating'),
    riskProfile_riskScore: numeric('risk_profile_risk_score'),
    riskProfile_lastAssessmentDate: timestamp('risk_profile_last_assessment_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }),
    riskMetrics_defaultProbability: numeric('risk_metrics_default_probability'),
    riskMetrics_lossGivenDefault: numeric('risk_metrics_loss_given_default'),
    riskMetrics_exposureAtDefault: numeric('risk_metrics_exposure_at_default'),
    riskMetrics_expectedCreditLoss: numeric('risk_metrics_expected_credit_loss'),
    factoringSettings_enabled: boolean('factoring_settings_enabled').default(false),
    factoringSettings_maxAdvancePercentage: numeric(
      'factoring_settings_max_advance_percentage',
    ).default('90'),
    factoringSettings_defaultTenureDays: numeric('factoring_settings_default_tenure_days').default(
      '14',
    ),
    factoringSettings_minDaysBetweenAdvances: numeric(
      'factoring_settings_min_days_between_advances',
    ).default('7'),
    factoringStats_totalAdvanceAmount: numeric('factoring_stats_total_advance_amount').default('0'),
    factoringStats_outstandingAdvances: numeric('factoring_stats_outstanding_advances').default(
      '0',
    ),
    factoringStats_averageRepaymentTime: numeric('factoring_stats_average_repayment_time').default(
      '0',
    ),
    factoringStats_lastAdvanceDate: timestamp('factoring_stats_last_advance_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }),
  ...
  (columns) => ({
    employers_avatar_idx: index('employers_avatar_idx').on(columns.avatar),
    employers_user_id_idx: index('employers_user_id_idx').on(columns.userId),
    employers_company_u_u_i_d_idx: uniqueIndex('employers_company_u_u_i_d_idx').on(
      columns.companyUUID,
    ),
    employers_registration_number_idx: uniqueIndex('employers_registration_number_idx').on(
      columns.registrationNumber,
    ),
    employers_email_idx: uniqueIndex('employers_email_idx').on(columns.email),
  }),
)

export const employees_advance_history = pgTable(
  'employees_advance_history',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    advanceId: integer('advance_id_id').references(() => payroll_advances.id, {
      onDelete: 'set null',
    }),
    amount: numeric('amount'),
    date: timestamp('date', { mode: 'string', withTimezone: true, precision: 3 }),
    status: enum_employees_advance_history_status('status'),
  },
  (columns) => ({
    _orderIdx: index('employees_advance_history_order_idx').on(columns._order),
    _parentIDIdx: index('employees_advance_history_parent_id_idx').on(columns._parentID),
    employees_advance_history_advance_id_idx: index('employees_advance_history_advance_id_idx').on(
      columns.advanceId,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [employees.id],
      name: 'employees_advance_history_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const employees_documents = pgTable(
  'employees_documents',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    ...
    documentType: enum_employees_documents_document_type('document_type'),
    description: varchar('description'),
  },
  (columns) => ({
    _orderIdx: index('employees_documents_order_idx').on(columns._order),
    _parentIDIdx: index('employees_documents_parent_id_idx').on(columns._parentID),
    employees_documents_file_idx: index('employees_documents_file_idx').on(columns.file),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [employees.id],
      name: 'employees_documents_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const employees = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    employeeUuid: varchar('employee_uuid').notNull(),
    userId: integer('user_id_id')
      .notNull()
      .references(() => users.id, {
        onDelete: 'set null',
      }),
    employerId: integer('employer_id_id')
      .notNull()
    ...
    maritalStatus: enum_employees_marital_status('marital_status').notNull(),
    ...
    companyUUID: integer('company_u_u_i_d_id')
      .notNull()
      .references(() => employers.id, {
        onDelete: 'set null',
      }),
    ...
    employmentType: enum_employees_employment_type('employment_type').notNull(),
    employmentStatus: enum_employees_employment_status('employment_status').notNull(),
    jobTitle: varchar('job_title').notNull(),
    basicMonthlyPayNet: numeric('basic_monthly_pay_net').notNull(),
    paymentDetails_bankName: varchar('payment_details_bank_name').notNull(),
    paymentDetails_accountNumber: varchar('payment_details_account_number').notNull(),
    ...
    advanceSettings_advanceLimit: numeric('advance_settings_advance_limit').notNull().default('30'),
    advanceSettings_creditScore: numeric('advance_settings_credit_score'),
    advanceSettings_riskCategory: enum_employees_advance_settings_risk_category(
      'advance_settings_risk_category',
    ),
    bankDetails_bankName: varchar('bank_details_bank_name').notNull(),
    bankDetails_accountNumber: varchar('bank_details_account_number').notNull(),
    bankDetails_accountName: varchar('bank_details_account_name').notNull(),
    bankDetails_accountType: enum_employees_bank_details_account_type(
      'bank_details_account_type',
    ).notNull(),
    authProvider: enum_employees_auth_provider('auth_provider').notNull().default('local'),
    googleId: varchar('google_id'),
    facebookId: varchar('facebook_id'),
    status: enum_employees_status('status').notNull().default('pending'),
    lastLogin: timestamp('last_login', { mode: 'string', withTimezone: true, precision: 3 }),
    employmentDuration: numeric('employment_duration'),
    ...
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    loanAccess_isApproved: boolean('loan_access_is_approved').default(false),
    loanAccess_approvedBy: integer('loan_access_approved_by_id').references(() => users.id, {
      onDelete: 'set null',
    }),
    loanAccess_approvalDate: timestamp('loan_access_approval_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }),
    loanAccess_creditScore: numeric('loan_access_credit_score'),
    membershipTier: enum_employees_membership_tier('membership_tier').notNull(),
    enableAPIKey: boolean('enable_a_p_i_key'),
    apiKey: varchar('api_key'),
    apiKeyIndex: varchar('api_key_index'),
    email: varchar('email').notNull(),
  ...
  (columns) => ({
    employees_employee_uuid_idx: uniqueIndex('employees_employee_uuid_idx').on(
      columns.employeeUuid,
    ),
    employees_user_id_idx: index('employees_user_id_idx').on(columns.userId),
    employees_employer_id_idx: index('employees_employer_id_idx').on(columns.employerId),
    employees_employee_id_idx: uniqueIndex('employees_employee_id_idx').on(columns.employeeId),
    employees_employer_profile_idx: index('employees_employer_profile_idx').on(
      columns.employerProfile,
    ),
    employees_company_u_u_i_d_idx: index('employees_company_u_u_i_d_idx').on(columns.companyUUID),
    employees_loan_access_loan_access_approved_by_idx: index(
      'employees_loan_access_loan_access_approved_by_idx',
    ).on(columns.loanAccess_approvedBy),
    employees_email_idx: uniqueIndex('employees_email_idx').on(columns.email),
  }),
)

export const payroll_advances = pgTable(
  'payroll_advances',
  {
    id: serial('id').primaryKey(),
    advanceId: varchar('advance_id').notNull(),
    employeeId: integer('employee_id_id')
      .notNull()
    ...
    netDisbursementAmount: numeric('net_disbursement_amount'),
    workingDaysCompleted: numeric('working_days_completed').notNull(),
    earnedSalaryAmount: numeric('earned_salary_amount').notNull(),
    repaymentDueDate: timestamp('repayment_due_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }).notNull(),
    status: enum_payroll_advances_status('status').notNull().default('requested'),
    requestDate: timestamp('request_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }).notNull(),
    approvalDate: timestamp('approval_date', { mode: 'string', withTimezone: true, precision: 3 }),
    ...
    lastUpdatedBy: integer('last_updated_by_id').references(() => users.id, {
      onDelete: 'set null',
    }),
    membershipTier: enum_payroll_advances_membership_tier('membership_tier').notNull(),
    payrollPeriod_startDate: timestamp('payroll_period_start_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }).notNull(),
    payrollPeriod_endDate: timestamp('payroll_period_end_date', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }).notNull(),
  ...
  (columns) => ({
    payroll_advances_advance_id_idx: uniqueIndex('payroll_advances_advance_id_idx').on(
      columns.advanceId,
    ),
    payroll_advances_employee_id_idx: index('payroll_advances_employee_id_idx').on(
      columns.employeeId,
    ),
    payroll_advances_company_u_u_i_d_idx: index('payroll_advances_company_u_u_i_d_idx').on(
      columns.companyUUID,
    ),
    payroll_advances_created_by_idx: index('payroll_advances_created_by_idx').on(columns.createdBy),
    payroll_advances_last_updated_by_idx: index('payroll_advances_last_updated_by_idx').on(
      columns.lastUpdatedBy,
    ),
    payroll_advances_updated_at_idx: index('payroll_advances_updated_at_idx').on(columns.updatedAt),
    payroll_advances_created_at_idx: index('payroll_advances_created_at_idx').on(columns.createdAt),
  }),
)

export const payroll_repayments = pgTable(
  'payroll_repayments',
  {
    id: serial('id').primaryKey(),
    repaymentId: varchar('repayment_id').notNull(),
    advanceId: integer('advance_id_id')
      .notNull()
      .references(() => payroll_advances.id, {
        onDelete: 'set null',
      }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
  ...
  (columns) => ({
    payroll_repayments_repayment_id_idx: uniqueIndex('payroll_repayments_repayment_id_idx').on(
      columns.repaymentId,
    ),
    payroll_repayments_advance_id_idx: index('payroll_repayments_advance_id_idx').on(
      columns.advanceId,
    ),
    payroll_repayments_updated_at_idx: index('payroll_repayments_updated_at_idx').on(
      columns.updatedAt,
    ),
    payroll_repayments_created_at_idx: index('payroll_repayments_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)
...
export const payrolls = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    payrollId: varchar('payroll_id').notNull(),
    employerId: integer('employer_id_id')
      .notNull()
      .references(() => employers.id, {
        onDelete: 'set null',
  ...
  (columns) => ({
    payrolls_payroll_id_idx: uniqueIndex('payrolls_payroll_id_idx').on(columns.payrollId),
    payrolls_employer_id_idx: index('payrolls_employer_id_idx').on(columns.employerId),
    payrolls_updated_at_idx: index('payrolls_updated_at_idx').on(columns.updatedAt),
    payrolls_created_at_idx: index('payrolls_created_at_idx').on(columns.createdAt),
  }),
)

export const payroll_transactions_fees = pgTable(
  'payroll_transactions_fees',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    feeType: enum_payroll_transactions_fees_fee_type('fee_type').notNull(),
    amount: numeric('amount').notNull(),
    description: varchar('description'),
  },
  (columns) => ({
    _orderIdx: index('payroll_transactions_fees_order_idx').on(columns._order),
    _parentIDIdx: index('payroll_transactions_fees_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [payroll_transactions.id],
      name: 'payroll_transactions_fees_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const payroll_transactions_metadata_attachments = pgTable(
  'payroll_transactions_metadata_attachments',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('payroll_transactions_metadata_attachments_order_idx').on(columns._order),
    _parentIDIdx: index('payroll_transactions_metadata_attachments_parent_id_idx').on(
      columns._parentID,
    ),
    payroll_transactions_metadata_attachments_file_idx: index(
      'payroll_transactions_metadata_attachments_file_idx',
    ).on(columns.file),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [payroll_transactions.id],
      name: 'payroll_transactions_metadata_attachments_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const payroll_transactions = pgTable(
  'payroll_transactions',
  {
    ...
    repaymentId: integer('repayment_id_id').references(() => payroll_repayments.id, {
      onDelete: 'set null',
    }),
    ...
    transactionType: enum_payroll_transactions_transaction_type('transaction_type').notNull(),
    amount: numeric('amount').notNull(),
    paymentStatus: enum_payroll_transactions_payment_status('payment_status')
      .notNull()
      .default('processing'),
    bankDetails_bankName: varchar('bank_details_bank_name'),
    bankDetails_accountNumber: varchar('bank_details_account_number'),
    bankDetails_routingNumber: varchar('bank_details_routing_number'),
    bankDetails_referenceNumber: varchar('bank_details_reference_number'),
    reconciliationStatus:
      enum_payroll_transactions_reconciliation_status('reconciliation_status').default('pending'),
    metadata_initiatedBy: integer('metadata_initiated_by_id').references(() => users.id, {
      onDelete: 'set null',
    }),
    metadata_approvedBy: integer('metadata_approved_by_id').references(() => users.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => ({
    payroll_transactions_transaction_id_idx: uniqueIndex(
      'payroll_transactions_transaction_id_idx',
    ).on(columns.transactionId),
    payroll_transactions_company_u_u_i_d_idx: index('payroll_transactions_company_u_u_i_d_idx').on(
      columns.companyUUID,
    ),
    payroll_transactions_employee_id_idx: index('payroll_transactions_employee_id_idx').on(
      columns.employeeId,
    ),
    payroll_transactions_advance_id_idx: index('payroll_transactions_advance_id_idx').on(
      columns.advanceId,
    ),
    payroll_transactions_repayment_id_idx: index('payroll_transactions_repayment_id_idx').on(
      columns.repaymentId,
    ),
    payroll_transactions_metadata_metadata_initiated_by_idx: index(
      'payroll_transactions_metadata_metadata_initiated_by_idx',
    ).on(columns.metadata_initiatedBy),
    payroll_transactions_metadata_metadata_approved_by_idx: index(
      'payroll_transactions_metadata_metadata_approved_by_idx',
    ).on(columns.metadata_approvedBy),
  }),
)

export const factoring_calculations = pgTable(
  'factoring_calculations',
  {
    id: serial('id').primaryKey(),
    advanceId: varchar('advance_id').notNull(),
    employerId: integer('employer_id_id')
    ...
    payrollId: integer('payroll_id_id')
      .notNull()
      .references(() => payrolls.id, {
        onDelete: 'set null',
      }),
    riskScore: numeric('risk_score'),
    riskCategory: enum_factoring_calculations_risk_category('risk_category'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => ({
    factoring_calculations_advance_id_idx: uniqueIndex('factoring_calculations_advance_id_idx').on(
      columns.advanceId,
    ),
    factoring_calculations_employer_id_idx: index('factoring_calculations_employer_id_idx').on(
      columns.employerId,
    ),
    factoring_calculations_payroll_id_idx: index('factoring_calculations_payroll_id_idx').on(
      columns.payrollId,
    ),
    factoring_calculations_updated_at_idx: index('factoring_calculations_updated_at_idx').on(
      columns.updatedAt,
    ),
    factoring_calculations_created_at_idx: index('factoring_calculations_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)

export const factoring_repayments_late_fees = pgTable(
  'factoring_repayments_late_fees',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    feeDate: timestamp('fee_date', { mode: 'string', withTimezone: true, precision: 3 }).notNull(),
    feeType: enum_factoring_repayments_late_fees_fee_type('fee_type').notNull(),
    feeAmount: numeric('fee_amount').notNull(),
    paid: boolean('paid').default(false),
  },
  (columns) => ({
    _orderIdx: index('factoring_repayments_late_fees_order_idx').on(columns._order),
    _parentIDIdx: index('factoring_repayments_late_fees_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [factoring_repayments.id],
      name: 'factoring_repayments_late_fees_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const factoring_repayments_payment_history = pgTable(
  'factoring_repayments_payment_history',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    amount: numeric('amount').notNull(),
    paymentMethod:
      enum_factoring_repayments_payment_history_payment_method('payment_method').notNull(),
    referenceNumber: varchar('reference_number'),
  },
  (columns) => ({
    _orderIdx: index('factoring_repayments_payment_history_order_idx').on(columns._order),
    _parentIDIdx: index('factoring_repayments_payment_history_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [factoring_repayments.id],
      name: 'factoring_repayments_payment_history_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const factoring_repayments = pgTable(
  'factoring_repayments',
  {
    id: serial('id').primaryKey(),
    repaymentId: varchar('repayment_id').notNull(),
    advanceId: integer('advance_id_id')
      .notNull()
      .references(() => factoring_calculations.id, {
        onDelete: 'set null',
      }),
    companyUUID: integer('company_u_u_i_d_id')
      .notNull()
    ...
    totalAmountPaid: numeric('total_amount_paid').default('0'),
    paymentStatus: enum_factoring_repayments_payment_status('payment_status')
      .notNull()
      .default('pending'),
    amountDue_principal: numeric('amount_due_principal').notNull(),
    amountDue_interest: numeric('amount_due_interest').notNull(),
    amountDue_fees: numeric('amount_due_fees').default('0'),
    amountPaid_principal: numeric('amount_paid_principal').default('0'),
    amountPaid_interest: numeric('amount_paid_interest').default('0'),
    amountPaid_fees: numeric('amount_paid_fees').default('0'),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => ({
    factoring_repayments_repayment_id_idx: uniqueIndex('factoring_repayments_repayment_id_idx').on(
      columns.repaymentId,
    ),
    factoring_repayments_advance_id_idx: index('factoring_repayments_advance_id_idx').on(
      columns.advanceId,
    ),
    factoring_repayments_company_u_u_i_d_idx: index('factoring_repayments_company_u_u_i_d_idx').on(
      columns.companyUUID,
    ),
  }),
)

export const payroll_factoring = pgTable(
  'payroll_factoring',
  {
    id: serial('id').primaryKey(),
    factorUUID: varchar('factor_u_u_i_d').notNull(),
    companyUUID: integer('company_u_u_i_d_id')
      .notNull()
      .references(() => employers.id, {
        onDelete: 'set null',
  ...
  (columns) => ({
    payroll_factoring_factor_u_u_i_d_idx: uniqueIndex('payroll_factoring_factor_u_u_i_d_idx').on(
      columns.factorUUID,
    ),
    payroll_factoring_company_u_u_i_d_idx: index('payroll_factoring_company_u_u_i_d_idx').on(
      columns.companyUUID,
    ),
    payroll_factoring_updated_at_idx: index('payroll_factoring_updated_at_idx').on(
      columns.updatedAt,
    ),
    payroll_factoring_created_at_idx: index('payroll_factoring_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    categoriesID: integer('categories_id'),
    usersID: integer('users_id'),
    employersID: integer('employers_id'),
    employeesID: integer('employees_id'),
    'payroll-advancesID': integer('payroll_advances_id'),
    'payroll-repaymentsID': integer('payroll_repayments_id'),
    payrollsID: integer('payrolls_id'),
    'payroll-transactionsID': integer('payroll_transactions_id'),
    'factoring-calculationsID': integer('factoring_calculations_id'),
    'factoring-repaymentsID': integer('factoring_repayments_id'),
    'payroll-factoringID': integer('payroll_factoring_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_employers_id_idx: index(
      'payload_locked_documents_rels_employers_id_idx',
    ).on(columns.employersID),
    payload_locked_documents_rels_employees_id_idx: index(
      'payload_locked_documents_rels_employees_id_idx',
    ).on(columns.employeesID),
    payload_locked_documents_rels_payroll_advances_id_idx: index(
      'payload_locked_documents_rels_payroll_advances_id_idx',
    ).on(columns['payroll-advancesID']),
    payload_locked_documents_rels_payroll_repayments_id_idx: index(
      'payload_locked_documents_rels_payroll_repayments_id_idx',
    ).on(columns['payroll-repaymentsID']),
    payload_locked_documents_rels_payrolls_id_idx: index(
      'payload_locked_documents_rels_payrolls_id_idx',
    ).on(columns.payrollsID),
    payload_locked_documents_rels_payroll_transactions_id_idx: index(
      'payload_locked_documents_rels_payroll_transactions_id_idx',
    ).on(columns['payroll-transactionsID']),
    payload_locked_documents_rels_factoring_calculations_id_idx: index(
      'payload_locked_documents_rels_factoring_calculations_id_idx',
    ).on(columns['factoring-calculationsID']),
    payload_locked_documents_rels_factoring_repayments_id_idx: index(
      'payload_locked_documents_rels_factoring_repayments_id_idx',
    ).on(columns['factoring-repaymentsID']),
    payload_locked_documents_rels_payroll_factoring_id_idx: index(
      'payload_locked_documents_rels_payroll_factoring_id_idx',
    ).on(columns['payroll-factoringID']),
    ...
    employersIdFk: foreignKey({
      columns: [columns['employersID']],
      foreignColumns: [employers.id],
      name: 'payload_locked_documents_rels_employers_fk',
    }).onDelete('cascade'),
    ...
    'payroll-advancesIdFk': foreignKey({
      columns: [columns['payroll-advancesID']],
      foreignColumns: [payroll_advances.id],
      name: 'payload_locked_documents_rels_payroll_advances_fk',
    }).onDelete('cascade'),
    'payroll-repaymentsIdFk': foreignKey({
      columns: [columns['payroll-repaymentsID']],
      foreignColumns: [payroll_repayments.id],
      name: 'payload_locked_documents_rels_payroll_repayments_fk',
    }).onDelete('cascade'),
    payrollsIdFk: foreignKey({
      columns: [columns['payrollsID']],
      foreignColumns: [payrolls.id],
      name: 'payload_locked_documents_rels_payrolls_fk',
    }).onDelete('cascade'),
    'payroll-transactionsIdFk': foreignKey({
      columns: [columns['payroll-transactionsID']],
      foreignColumns: [payroll_transactions.id],
      name: 'payload_locked_documents_rels_payroll_transactions_fk',
    }).onDelete('cascade'),
    'factoring-calculationsIdFk': foreignKey({
      columns: [columns['factoring-calculationsID']],
      foreignColumns: [factoring_calculations.id],
      name: 'payload_locked_documents_rels_factoring_calculations_fk',
    }).onDelete('cascade'),
    'factoring-repaymentsIdFk': foreignKey({
      columns: [columns['factoring-repaymentsID']],
      foreignColumns: [factoring_repayments.id],
      name: 'payload_locked_documents_rels_factoring_repayments_fk',
    }).onDelete('cascade'),
    'payroll-factoringIdFk': foreignKey({
      columns: [columns['payroll-factoringID']],
      foreignColumns: [payroll_factoring.id],
      name: 'payload_locked_documents_rels_payroll_factoring_fk',
    }).onDelete('cascade'),
...
export const payload_preferences_rels = pgTable(
  ...
  (columns) => ({
    ...
    payload_preferences_rels_employers_id_idx: index(
      'payload_preferences_rels_employers_id_idx',
    ).on(columns.employersID),
    payload_preferences_rels_employees_id_idx: index(
      'payload_preferences_rels_employees_id_idx',
    ).on(columns.employeesID),
    parentFk: foreignKey({
      columns: [columns['parent']],
    ...
    employersIdFk: foreignKey({
      columns: [columns['employersID']],
      foreignColumns: [employers.id],
      name: 'payload_preferences_rels_employers_fk',
    }).onDelete('cascade'),
    employeesIdFk: foreignKey({
      columns: [columns['employeesID']],
      foreignColumns: [employees.id],
      name: 'payload_preferences_rels_employees_fk',
    }).onDelete('cascade'),
  }),
)
...
export const relations_users_permissions = relations(users_permissions, ({ one }) => ({
  parent: one(users, {
    fields: [users_permissions.parent],
    references: [users.id],
...
export const relations_users = relations(users, ({ one, many }) => ({
  ...
  employeeProfile: one(employees, {
    fields: [users.employeeProfile],
    references: [employees.id],
    relationName: 'employeeProfile',
  }),
  employerProfile: one(employers, {
    fields: [users.employerProfile],
    references: [employers.id],
    relationName: 'employerProfile',
  }),
}))
export const relations_employers_payroll_settings_payroll_dates = relations(
  employers_payroll_settings_payroll_dates,
  ({ one }) => ({
    _parentID: one(employers, {
      fields: [employers_payroll_settings_payroll_dates._parentID],
      references: [employers.id],
      relationName: 'payrollSettings_payrollDates',
    }),
  }),
)
export const relations_employers = relations(employers, ({ one, many }) => ({
  avatar: one(media, {
    fields: [employers.avatar],
    references: [media.id],
    relationName: 'avatar',
  }),
  userId: one(users, {
  ...
  payrollSettings_payrollDates: many(employers_payroll_settings_payroll_dates, {
    relationName: 'payrollSettings_payrollDates',
  }),
}))
export const relations_employees_advance_history = relations(
  employees_advance_history,
  ({ one }) => ({
    _parentID: one(employees, {
      fields: [employees_advance_history._parentID],
      references: [employees.id],
      relationName: 'advanceHistory',
    }),
    advanceId: one(payroll_advances, {
      fields: [employees_advance_history.advanceId],
      references: [payroll_advances.id],
      relationName: 'advanceId',
    }),
  }),
)
export const relations_employees_documents = relations(employees_documents, ({ one }) => ({
  _parentID: one(employees, {
    fields: [employees_documents._parentID],
    references: [employees.id],
    relationName: 'documents',
  }),
  file: one(media, {
    fields: [employees_documents.file],
    references: [media.id],
    relationName: 'file',
  }),
}))
export const relations_employees = relations(employees, ({ one, many }) => ({
  userId: one(users, {
    fields: [employees.userId],
    references: [users.id],
    relationName: 'userId',
  }),
  employerId: one(employers, {
    fields: [employees.employerId],
    references: [employers.id],
    relationName: 'employerId',
  }),
  employerProfile: one(employers, {
    fields: [employees.employerProfile],
    references: [employers.id],
    relationName: 'employerProfile',
  }),
  companyUUID: one(employers, {
    fields: [employees.companyUUID],
    references: [employers.id],
    relationName: 'companyUUID',
  }),
  advanceHistory: many(employees_advance_history, {
    relationName: 'advanceHistory',
  }),
  loanAccess_approvedBy: one(users, {
    fields: [employees.loanAccess_approvedBy],
    references: [users.id],
    relationName: 'loanAccess_approvedBy',
  }),
  documents: many(employees_documents, {
    relationName: 'documents',
  }),
}))
export const relations_payroll_advances = relations(payroll_advances, ({ one }) => ({
  employeeId: one(employees, {
    fields: [payroll_advances.employeeId],
    references: [employees.id],
    relationName: 'employeeId',
  }),
  companyUUID: one(employers, {
    fields: [payroll_advances.companyUUID],
    references: [employers.id],
    relationName: 'companyUUID',
  }),
  createdBy: one(users, {
    fields: [payroll_advances.createdBy],
    references: [users.id],
    relationName: 'createdBy',
  }),
  lastUpdatedBy: one(users, {
    fields: [payroll_advances.lastUpdatedBy],
    references: [users.id],
    relationName: 'lastUpdatedBy',
  }),
}))
export const relations_payroll_repayments = relations(payroll_repayments, ({ one }) => ({
  advanceId: one(payroll_advances, {
    fields: [payroll_repayments.advanceId],
    references: [payroll_advances.id],
    relationName: 'advanceId',
  }),
}))
export const relations_payrolls = relations(payrolls, ({ one }) => ({
  employerId: one(employers, {
    fields: [payrolls.employerId],
    references: [employers.id],
    relationName: 'employerId',
  }),
}))
export const relations_payroll_transactions_fees = relations(
  payroll_transactions_fees,
  ({ one }) => ({
    _parentID: one(payroll_transactions, {
      fields: [payroll_transactions_fees._parentID],
      references: [payroll_transactions.id],
      relationName: 'fees',
    }),
  }),
)
export const relations_payroll_transactions_metadata_attachments = relations(
  payroll_transactions_metadata_attachments,
  ({ one }) => ({
    _parentID: one(payroll_transactions, {
      fields: [payroll_transactions_metadata_attachments._parentID],
      references: [payroll_transactions.id],
      relationName: 'metadata_attachments',
    }),
    file: one(media, {
      fields: [payroll_transactions_metadata_attachments.file],
      references: [media.id],
      relationName: 'file',
    }),
  }),
)
export const relations_payroll_transactions = relations(payroll_transactions, ({ one, many }) => ({
  companyUUID: one(employers, {
    fields: [payroll_transactions.companyUUID],
    references: [employers.id],
    relationName: 'companyUUID',
  }),
  employeeId: one(employees, {
    fields: [payroll_transactions.employeeId],
    references: [employees.id],
    relationName: 'employeeId',
  }),
  advanceId: one(payroll_advances, {
    fields: [payroll_transactions.advanceId],
    references: [payroll_advances.id],
    relationName: 'advanceId',
  }),
  repaymentId: one(payroll_repayments, {
    fields: [payroll_transactions.repaymentId],
    references: [payroll_repayments.id],
    relationName: 'repaymentId',
  }),
  fees: many(payroll_transactions_fees, {
    relationName: 'fees',
  }),
  metadata_initiatedBy: one(users, {
    fields: [payroll_transactions.metadata_initiatedBy],
    references: [users.id],
    relationName: 'metadata_initiatedBy',
  }),
  metadata_approvedBy: one(users, {
    fields: [payroll_transactions.metadata_approvedBy],
    references: [users.id],
    relationName: 'metadata_approvedBy',
  }),
  metadata_attachments: many(payroll_transactions_metadata_attachments, {
    relationName: 'metadata_attachments',
  }),
}))
export const relations_factoring_calculations = relations(factoring_calculations, ({ one }) => ({
  employerId: one(employers, {
    fields: [factoring_calculations.employerId],
    references: [employers.id],
    relationName: 'employerId',
  }),
  payrollId: one(payrolls, {
    fields: [factoring_calculations.payrollId],
    references: [payrolls.id],
    relationName: 'payrollId',
  }),
}))
export const relations_factoring_repayments_late_fees = relations(
  factoring_repayments_late_fees,
  ({ one }) => ({
    _parentID: one(factoring_repayments, {
      fields: [factoring_repayments_late_fees._parentID],
      references: [factoring_repayments.id],
      relationName: 'lateFees',
    }),
  }),
)
export const relations_factoring_repayments_payment_history = relations(
  factoring_repayments_payment_history,
  ({ one }) => ({
    _parentID: one(factoring_repayments, {
      fields: [factoring_repayments_payment_history._parentID],
      references: [factoring_repayments.id],
      relationName: 'paymentHistory',
    }),
  }),
)
export const relations_factoring_repayments = relations(factoring_repayments, ({ one, many }) => ({
  advanceId: one(factoring_calculations, {
    fields: [factoring_repayments.advanceId],
    references: [factoring_calculations.id],
    relationName: 'advanceId',
  }),
  companyUUID: one(employers, {
    fields: [factoring_repayments.companyUUID],
    references: [employers.id],
    relationName: 'companyUUID',
  }),
  lateFees: many(factoring_repayments_late_fees, {
    relationName: 'lateFees',
  }),
  paymentHistory: many(factoring_repayments_payment_history, {
    relationName: 'paymentHistory',
  }),
}))
export const relations_payroll_factoring = relations(payroll_factoring, ({ one }) => ({
  companyUUID: one(employers, {
    fields: [payroll_factoring.companyUUID],
    references: [employers.id],
    relationName: 'companyUUID',
  }),
}))
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    employersID: one(employers, {
      fields: [payload_locked_documents_rels.employersID],
      references: [employers.id],
      relationName: 'employers',
    }),
    ...
    'payroll-advancesID': one(payroll_advances, {
      fields: [payload_locked_documents_rels['payroll-advancesID']],
      references: [payroll_advances.id],
      relationName: 'payroll-advances',
    }),
    'payroll-repaymentsID': one(payroll_repayments, {
      fields: [payload_locked_documents_rels['payroll-repaymentsID']],
      references: [payroll_repayments.id],
      relationName: 'payroll-repayments',
    }),
    payrollsID: one(payrolls, {
      fields: [payload_locked_documents_rels.payrollsID],
      references: [payrolls.id],
      relationName: 'payrolls',
    }),
    'payroll-transactionsID': one(payroll_transactions, {
      fields: [payload_locked_documents_rels['payroll-transactionsID']],
      references: [payroll_transactions.id],
      relationName: 'payroll-transactions',
    }),
    'factoring-calculationsID': one(factoring_calculations, {
      fields: [payload_locked_documents_rels['factoring-calculationsID']],
      references: [factoring_calculations.id],
      relationName: 'factoring-calculations',
    }),
    'factoring-repaymentsID': one(factoring_repayments, {
      fields: [payload_locked_documents_rels['factoring-repaymentsID']],
      references: [factoring_repayments.id],
      relationName: 'factoring-repayments',
    }),
    'payroll-factoringID': one(payroll_factoring, {
      fields: [payload_locked_documents_rels['payroll-factoringID']],
      references: [payroll_factoring.id],
      relationName: 'payroll-factoring',
    }),
...
export const relations_payload_preferences_rels = relations(
  ...
  ({ one }) => ({
    ...
    employersID: one(employers, {
      fields: [payload_preferences_rels.employersID],
      references: [employers.id],
      relationName: 'employers',
    }),
    employeesID: one(employees, {
      fields: [payload_preferences_rels.employeesID],
      references: [employees.id],
      relationName: 'employees',
    }),
  }),
...
type DatabaseSchema = {
  ...
  enum_users_permissions: typeof enum_users_permissions
  enum_users_role: typeof enum_users_role
  enum_users_status: typeof enum_users_status
  enum_users_investment_details_profit_distribution_type: typeof enum_users_investment_details_profit_distribution_type
  enum_users_membership_tier: typeof enum_users_membership_tier
  enum_users_last_repayment_status: typeof enum_users_last_repayment_status
  enum_users_auth_provider: typeof enum_users_auth_provider
  enum_employers_auth_provider: typeof enum_employers_auth_provider
  enum_employers_business_type: typeof enum_employers_business_type
  enum_employers_status: typeof enum_employers_status
  enum_employers_payroll_settings_payroll_cycle: typeof enum_employers_payroll_settings_payroll_cycle
  enum_employers_risk_assessment_risk_category: typeof enum_employers_risk_assessment_risk_category
  enum_employers_risk_profile_risk_rating: typeof enum_employers_risk_profile_risk_rating
  enum_employees_advance_history_status: typeof enum_employees_advance_history_status
  enum_employees_documents_document_type: typeof enum_employees_documents_document_type
  enum_employees_marital_status: typeof enum_employees_marital_status
  enum_employees_employment_type: typeof enum_employees_employment_type
  enum_employees_employment_status: typeof enum_employees_employment_status
  enum_employees_advance_settings_risk_category: typeof enum_employees_advance_settings_risk_category
  enum_employees_bank_details_account_type: typeof enum_employees_bank_details_account_type
  enum_employees_auth_provider: typeof enum_employees_auth_provider
  enum_employees_status: typeof enum_employees_status
  enum_employees_membership_tier: typeof enum_employees_membership_tier
  enum_payroll_advances_status: typeof enum_payroll_advances_status
  enum_payroll_advances_membership_tier: typeof enum_payroll_advances_membership_tier
  enum_payroll_transactions_fees_fee_type: typeof enum_payroll_transactions_fees_fee_type
  enum_payroll_transactions_transaction_type: typeof enum_payroll_transactions_transaction_type
  enum_payroll_transactions_payment_status: typeof enum_payroll_transactions_payment_status
  enum_payroll_transactions_reconciliation_status: typeof enum_payroll_transactions_reconciliation_status
  enum_factoring_calculations_risk_category: typeof enum_factoring_calculations_risk_category
  enum_factoring_repayments_late_fees_fee_type: typeof enum_factoring_repayments_late_fees_fee_type
  enum_factoring_repayments_payment_history_payment_method: typeof enum_factoring_repayments_payment_history_payment_method
  enum_factoring_repayments_payment_status: typeof enum_factoring_repayments_payment_status
  ...
  users: typeof users
  employers_payroll_settings_payroll_dates: typeof employers_payroll_settings_payroll_dates
  employers: typeof employers
  employees_advance_history: typeof employees_advance_history
  employees_documents: typeof employees_documents
  employees: typeof employees
  payroll_advances: typeof payroll_advances
  payroll_repayments: typeof payroll_repayments
  payrolls: typeof payrolls
  payroll_transactions_fees: typeof payroll_transactions_fees
  payroll_transactions_metadata_attachments: typeof payroll_transactions_metadata_attachments
  payroll_transactions: typeof payroll_transactions
  factoring_calculations: typeof factoring_calculations
  factoring_repayments_late_fees: typeof factoring_repayments_late_fees
  factoring_repayments_payment_history: typeof factoring_repayments_payment_history
  factoring_repayments: typeof factoring_repayments
  payroll_factoring: typeof payroll_factoring
  ...
  relations_employers_payroll_settings_payroll_dates: typeof relations_employers_payroll_settings_payroll_dates
  relations_employers: typeof relations_employers
  relations_employees_advance_history: typeof relations_employees_advance_history
  relations_employees_documents: typeof relations_employees_documents
  relations_employees: typeof relations_employees
  relations_payroll_advances: typeof relations_payroll_advances
  relations_payroll_repayments: typeof relations_payroll_repayments
  relations_payrolls: typeof relations_payrolls
  relations_payroll_transactions_fees: typeof relations_payroll_transactions_fees
  relations_payroll_transactions_metadata_attachments: typeof relations_payroll_transactions_metadata_attachments
  relations_payroll_transactions: typeof relations_payroll_transactions
  relations_factoring_calculations: typeof relations_factoring_calculations
  relations_factoring_repayments_late_fees: typeof relations_factoring_repayments_late_fees
  relations_factoring_repayments_payment_history: typeof relations_factoring_repayments_payment_history
  relations_factoring_repayments: typeof relations_factoring_repayments
  relations_payroll_factoring: typeof relations_payroll_factoring
